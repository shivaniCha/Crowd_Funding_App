...
const createUserInput_1 = require("./createUserInput");
const bookMarkProject_DTO_1 = require("./bookMarkProject-DTO");
let UserResolver = class UserResolver {
    constructor(userService) {
        this.userService = userService;
    }
    async getUsers(_, __, ___, info) {
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('bookMark')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [bookMarkProject_DTO_1.BookMark]),
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "bookMarkAProject", null);
__decorate([
    (0, graphql_1.Query)(() => user_type_1.UserType),
